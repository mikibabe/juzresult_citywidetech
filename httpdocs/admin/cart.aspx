...
protected void Page_Load(Object Src, EventArgs E ) 
{
	...
	PrintHeaderAndMenu("");
	RememberLastPage();
    	Response.Write("<form action=cart.aspx?r=" + DateTime.UtcNow.AddHours(12).ToOADate() + " method=get>");
	...
	Response.Write(PrintCart(false, false, true)); //true to printer buttons
